...
致谢
====================================
+ 感谢[Less官网](https://less.bootcss.com/)的样式，本Jekyll框架的样式都是基于Less官网的样式直接拷贝过来的。只是重构了JS，并且加入了Jekyll语法而已。
...
<img src="{{ '/styles/images/zhifubao.PNG' | prepend: site.baseurl }}" alt="支付宝二维码付款给Kenny" width="310" />

微信
----------------
![微信二维码付款给Kenny]({{ '/styles/images/weixin.png' | prepend: site.baseurl }})
